...
```bash
composer require Nexusbrother/laravel-admin-operation-log-statistic
```
...
│   └── admin.php
├── migrations/
│   └── 2025_11_28_173148_create_admin_operation_log_statistics_tables.php
├── resources/
│   ├── lang/
│   │   ├── en/
│   │   │   └── admin-operation-log-statistic.php
│   │   └── zh-CN/
│   │       └── admin-operation-log-statistic.php
│   └── views/
│       └── mail/
│           └── admin-operation-log-statistic-warning.blade.php
├── scripts/
│   └── run-code-quality.sh
├── src/
│   ├── Console/
│   │   └── StatisticCommand.php
│   ├── Controllers/
│   │   └── AdminOperationLogStatisticController.php
│   ├── Mail/
│   │   ├── AdminOperationLogStatisticWarning.php
│   │   └── BaseMail.php
│   ├── Models/
│   │   └── AdminOperationLogStatistic.php
│   └── ServiceProvider.php
├── .gitignore
├── Dockerfile
├── README.md
